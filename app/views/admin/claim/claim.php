                ...
                <div class="flex items-center">
                  ...
                  <div class="hidden md:block">
                    <div class="ml-96 flex items-baseline space-x-4">
                        ...
                        <a href="../claim/claim.php" class="bg-gray-900 text-white px-3 py-2 rounded-md text-sm font-medium" aria-current="page" x-state:on="Current" x-state:off="Default" x-state-description="Current: &quot;bg-gray-900 text-white&quot;, Default: &quot;text-gray-300 hover:bg-gray-700 hover:text-white&quot;">Claim</a>
