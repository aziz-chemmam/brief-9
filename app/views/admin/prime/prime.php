...
<body>
  ...
  <?php
  require_once($_SERVER["DOCUMENT_ROOT"]."/brief-9/app/controllers/primeController.php");
  ?>
...
<div class="bg-gray-100">
            ...
            <table id="client" class="border-2">
                    ...
                    $premium = $primeService->display();
                     foreach ($premium as $premiums) : ?>
                        <tr>
                            <td class="py-2 px-4 border-b"><?= $premiums['premiumId']; ?></td>
                            <td class="py-2 px-4 border-b"><?= $premiums['date']; ?></td>
                            <td class="py-2 px-4 border-b"><?= $premiums['claimId']; ?></td>
                            <td class="py-2 px-4 border-b flex">
                            <form action="../../../controllers/primeController.php" method="post">
                                    <input type="hidden" name="action" value="editPrime">
                                    <input type="hidden" name="PrimeId" value="<?= $premiums['premiumId']; ?>">
                                    <button class="bg-yellow-500 text-white px-2 py-1 rounded mr-2">Edit</button>
                                </form>
                      
                                <form action="../../../controllers/primeController.php" method="post">
                                    <input type="hidden" name="action" value="deletePrime">
                                    <input type="hidden" name="deletePrimeId" value="<?= $premiums['premiumId']; ?>">
    ...
    <div id="overlay" class="hidden h-screen w-full fixed top-0 left-0 bg-black/10 flex justify-center items-center">
            ...
            <form action="../../../controllers/primeController.php" method="POST" id="overlay-form" class="w-[50%] bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="flex items-center p-6 space-x-3 rtl:space-x-reverse border-t border-gray-200 rounded-b dark:border-gray-600">
                        ...
                        <button type="submit" name="action" value="addPrime" class="text-white   focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-grey-800 dark:hover:bg-gray-900 dark:focus:ring-blue-800">
                            AJOUTER
                        </button>
                </div>
            </form>
